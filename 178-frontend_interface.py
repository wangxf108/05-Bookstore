...
#User can: Search an entry,Add entry,Update entry,Delete,Close
...
sb1=ttk.Scrollbar(window)                        # scrollbar 滚动条
...
b4=ttk.Button(window,text="Update selected", width=12)
b4.grid(row=5,column=3)

b5=ttk.Button(window,text="Delete selected", width=12)
